...
gender = st.selectbox('Gender', lbl_encoder_gender.classes_)
...
input_data = pd.DataFrame({
    ...
    'Gender' : [lbl_encoder_gender.transform([gender])[0]],
	'Age' : [age],
	'Tenure' : [tenure],
	'Balance' : [balance],
...
st.write(f'Predited Estimated Salary : €{predicted_salary:.2f}')